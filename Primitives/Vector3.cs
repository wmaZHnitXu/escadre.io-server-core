...
namespace Server.Core.Primitives
{
    ...
    public struct Vector3 : IEquatable<Vector3>, IFormattable
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public Vector3(Vector2 xy, float z) // Vector2 теперь из Core.Primitives
        {
            X = xy.X;
            Y = xy.Y;
            Z = z;
        ...
        public static Vector3 operator /(Vector3 a, float d) => new Vector3(a.X / d, a.Y / d, a.Z / d);
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool operator ==(Vector3 lhs, Vector3 rhs) => (lhs - rhs).SqrMagnitude < Epsilon * Epsilon;
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public bool Equals(Vector3 other) => MathF.Abs(X - other.X) < Epsilon && MathF.Abs(Y - other.Y) < Epsilon && MathF.Abs(Z - other.Z) < Epsilon;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator Vector3(Vector2 v) => new Vector3(v.X, v.Y, 0); // Vector2 из того же неймспейса
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static explicit operator Vector2(Vector3 v) => new Vector2(v.X, v.Y); // Vector2 из того же неймспейса
    }
}